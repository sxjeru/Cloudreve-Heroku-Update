...
Cloudreve with redis 的 Docker 版本

---

一键部署在 Heroku 上：[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://www.heroku.com/deploy)
...
容器中的Cloudreve版本为 cloudreve_3.5.3_linux_amd64
